...
'<embed name="'+this.config.fid+'" id="'+this.config.fid+'" src="'+this.config.swf+'"';d+=' width="'+this.config.width+'" height="'+this.config.height+'" bgcolor="'+this.config.bgcolor+'"';d+=' quality="high" FlashVars="id='+escape(this.config.id)+"&fid="+escape(this.config.fid)+"&vol="+this.config.volume+'"';d+=' allowScriptAccess="always"';d+=' type="application/x-shockwave-flash" pluginspage="https://web.archive.org/web/20111227213714/http://www.macromedia.com/go/getflashplayer" />';this.element.html(d)}else this.element.html("<p>Flash 8 or above is not installed. <a href='https://web.archive.org/web/20111227213714/http://get.adobe.com/flashplayer'>Get Flash!</a></p>");
...
/*
     FILE ARCHIVED ON 21:37:14 Dec 27, 2011 AND RETRIEVED FROM THE
...
playback timings (ms):
  ...
  esindex: 0.017
  cdx.remote: 5.738
  LoadShardBlock: 221.079 (3)
  PetaboxLoader3.datanode: 210.034 (4)
  PetaboxLoader3.resolve: 203.576 (2)
  load_resource: 197.287
*/